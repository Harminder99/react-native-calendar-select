      ...
      <Modal
        ...
        <View style={[styles.container, mainBack]}>
          ...
          <View style={[styles.result,{marginTop: 10}]}>
            <View style={[styles.resultPart,{padding: 10,borderColor: "grey",borderWidth:1}]}>
            <Text style={[{color: "grey",fontSize: 14},styles.commonText]}>
            ...
            <Text style={[{color: "white",fontSize: 14},styles.commonText]}>
          ...
          <View style={styles.week}>
            {[7, 1, 2, 3, 4, 5, 6].map(item =>
              <Text style={[styles.weekText, {color: "grey"}]}　key={item}>{this._i18n(item, 'w')}</Text>
            )}
          </View>
          ...
          <View style={styles.btn}>
            {isValid ?
              ...
              <View style={[styles.confirmContainer, styles.confirmContainerDisabled,buttonBack]}>
                <View style={styles.confirmBtn}>
                  <Text
                    ellipsisMode="tail" numberOfLines={1}
                    style={[styles.confirmText, styles.confirmTextDisabled,{color:"white"}]}>
                    {this._i18n('save', 'text')}
                  </Text>
                </View>
              </View>
